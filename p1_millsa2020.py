# Aaron P. Mills & Joseph Valentine                Z-23547104 /
# Dr. Marques                   
# Intro to Artificial Intellligence CAP 4630 
# Assignment 1             /        17 June 2022 
# Github Link: https://github.com/AirealAce/Intro_AI_Project_01/blob/main/p1_millsa2020.py
...
class Checker(TwoPlayerGame):
    ...
    def make_move(self, pos):
        ...
        ------
        """
        #Determine how large the list matrix is
        (numOfRows, numOfColumns) = np.shape(pos)

        if self.current_player == 1:
            self.white_pieces.clear()
            self.white_pieces = [(x,y) for x in numOfRows for y in numOfColumns if pos[x,y] == "W"]
        elif self.current_player == 2:
            self.black_pieces.clear()
            self.black_pieces = [(x,y) for x in numOfRows for y in numOfColumns if pos[x,y] == "B"]
        #pass
